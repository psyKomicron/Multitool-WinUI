...
{
    public sealed partial class DriveInfoView : UserControl
    {
        ...
        private void SetGradients(bool active)
        {
            if (active)
            {
                SetFirstGradient(Tool.GetAppRessource<Color>("DarkDevBlue"));
                SetSecondGradient(Tool.GetAppRessource<Color>("DevBlue"));
